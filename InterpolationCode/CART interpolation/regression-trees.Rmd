...
rpart_model <- function(target, df) {
  ...
  train_test <- split_data(water_data)
  data_train <- data.frame(train_test[[1]])
  data_test <- data.frame(train_test[[2]])

  # the object type of data_train isn't right - i think the split_data function may not work well
